...
- (ZNKMASConstraint *)addConstraintWithAttributes:(ZNKMASAttribute)attrs {
    ...
    if (attrs & ZNKMASAttributeLeft) [attributes addObject:self.view.ZNKMAs_left];
    if (attrs & ZNKMASAttributeRight) [attributes addObject:self.view.ZNKMAs_right];
    if (attrs & ZNKMASAttributeTop) [attributes addObject:self.view.ZNKMAs_top];
    if (attrs & ZNKMASAttributeBottom) [attributes addObject:self.view.ZNKMAs_bottom];
    if (attrs & ZNKMASAttributeLeading) [attributes addObject:self.view.ZNKMAs_leading];
    if (attrs & ZNKMASAttributeTrailing) [attributes addObject:self.view.ZNKMAs_trailing];
    if (attrs & ZNKMASAttributeWidth) [attributes addObject:self.view.ZNKMAs_width];
    if (attrs & ZNKMASAttributeHeight) [attributes addObject:self.view.ZNKMAs_height];
    if (attrs & ZNKMASAttributeCenterX) [attributes addObject:self.view.ZNKMAs_centerX];
    if (attrs & ZNKMASAttributeCenterY) [attributes addObject:self.view.ZNKMAs_centerY];
    if (attrs & ZNKMASAttributeBaseline) [attributes addObject:self.view.ZNKMAs_baseline];
    
#if (__IPHONE_OS_VERSION_MIN_REQUIRED >= 80000) || (__TV_OS_VERSION_MIN_REQUIRED >= 9000) || (__ZNKMAC_OS_X_VERSION_MIN_REQUIRED >= 101100)
    
    if (attrs & ZNKMASAttributeFirstBaseline) [attributes addObject:self.view.ZNKMAs_firstBaseline];
    if (attrs & ZNKMASAttributeLastBaseline) [attributes addObject:self.view.ZNKMAs_lastBaseline];
    
#endif
    
#if (__IPHONE_OS_VERSION_MIN_REQUIRED >= 80000) || (__TV_OS_VERSION_MIN_REQUIRED >= 9000)
    
    if (attrs & ZNKMASAttributeLeftMargin) [attributes addObject:self.view.ZNKMAs_leftMargin];
    if (attrs & ZNKMASAttributeRightMargin) [attributes addObject:self.view.ZNKMAs_rightMargin];
    if (attrs & ZNKMASAttributeTopMargin) [attributes addObject:self.view.ZNKMAs_topMargin];
    if (attrs & ZNKMASAttributeBottomMargin) [attributes addObject:self.view.ZNKMAs_bottomMargin];
    if (attrs & ZNKMASAttributeLeadingMargin) [attributes addObject:self.view.ZNKMAs_leadingMargin];
    if (attrs & ZNKMASAttributeTrailingMargin) [attributes addObject:self.view.ZNKMAs_trailingMargin];
    if (attrs & ZNKMASAttributeCenterXWithinMargins) [attributes addObject:self.view.ZNKMAs_centerXWithinMargins];
    if (attrs & ZNKMASAttributeCenterYWithinMargins) [attributes addObject:self.view.ZNKMAs_centerYWithinMargins];
