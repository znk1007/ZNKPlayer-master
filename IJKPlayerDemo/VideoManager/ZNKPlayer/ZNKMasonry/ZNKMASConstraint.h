 ...
 */
#define ZNKMAs_equalTo(...)                 equalTo(ZNKMASBoxValue((__VA_ARGS__)))
#define ZNKMAs_greaterThanOrEqualTo(...)    greaterThanOrEqualTo(ZNKMASBoxValue((__VA_ARGS__)))
#define ZNKMAs_lessThanOrEqualTo(...)       lessThanOrEqualTo(ZNKMASBoxValue((__VA_ARGS__)))

#define ZNKMAs_offset(...)                  valueOffset(ZNKMASBoxValue((__VA_ARGS__)))


#ifdef MAS_SHORTHAND_GLOBALS

#define equalTo(...)                     ZNKMAs_equalTo(__VA_ARGS__)
#define greaterThanOrEqualTo(...)        ZNKMAs_greaterThanOrEqualTo(__VA_ARGS__)
#define lessThanOrEqualTo(...)           ZNKMAs_lessThanOrEqualTo(__VA_ARGS__)

#define offset(...)                      ZNKMAs_offset(__VA_ARGS__)
