 ...
 *
 *  view1.ZNKMAs_key = @"view1", view2.ZNKMAs_key = @"view2";
 *
 *  is equivalent to:
 *
...
#define ZNKMASAttachKeys(...)                                                        \
    {                                                                             \
        ...
        for (id key in keyPairs.allKeys) {                                        \
            id obj = keyPairs[key];                                               \
            NSAssert([obj respondsToSelector:@selector(setZNKMAs_key:)],             \
                     @"Cannot attach ZNKMAs_key to %@", obj);                        \
            [obj setZNKMAs_key:key];                                                 \
        }                                                                         \
    }
